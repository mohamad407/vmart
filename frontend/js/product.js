...
async function loadProduct() {
    ...
    if(p.billImage) {
        document.getElementById('p-bill').src = p.billImage;
        document.getElementById('p-bill').style.display = 'block';
    }
    
    if(p.usedDuration) {
        document.getElementById('p-used-wrapper').style.display = 'block';
        document.getElementById('p-used').innerText = `Used for: ${p.usedDuration}`;
    }
    
    // Setup Message Button to go to Chat
